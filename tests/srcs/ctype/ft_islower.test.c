...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/03 15:45:59 by rbroque           #+#    #+#             */
/*   Updated: 2022/09/04 09:23:58 by rbroque          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
START_TEST(zero)
{
	...
	ck_assert_int_eq(are_same_sign(ft_islower(c), islower(c)), 1);
}
END_TEST
